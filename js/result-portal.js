...
function resultCardMarkup(record) {
    ...
    return `<article class="a4-result-card" id="printableResultCard">
        ...
        <footer class="result-card-footer"><span>Computer-generated result card</span><div class="result-signature"><span class="signature-script">Damodar Valluru</span><i></i><strong>Academic Registrar</strong><small>Pinnacle Scholars Academy</small></div></footer>
    </article>`;
}
